...
export const KEYBINDINGS: readonly KeyBinding[] = [
  ...
  },
  {
    ...
    chord: { named: "tab" },
    display: "Tab / ⇧Tab",
    label: "Cycle catalog mode forward (⇧Tab back): series / anime / YouTube",
    hintLabel: "mode",
    scope: "browse",
    group: "While browsing",
    footerPriority: 15,
  ...
  },
  {
    id: "history-menu",
    chord: { input: "m" },
    label: "Open title actions for the highlighted row",
    hintLabel: "actions",
    scope: "history",
    group: "History",
    footerPriority: 12,
  ...
  {
    id: "history-mark-watched",
    chord: { input: "w" },
    label: "Toggle watched for the highlighted row",
    hintLabel: "watched",
    scope: "history",
    group: "History",
    helpOnly: true,
