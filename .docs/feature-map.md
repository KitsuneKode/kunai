...
| Playback target routing                    | `apps/cli/src/services/playback/PlaybackRouter.ts`, with local mpv adapted by `LocalPlaybackBackend.ts`              | [architecture.md](./architecture.md)                                             |
| Experimental Google Cast playback + LAN gateway | `apps/cli/src/services/playback/cast/*`                                                                  | [casting.md](./casting.md)                                                       |
