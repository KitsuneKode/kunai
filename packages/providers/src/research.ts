...
export const providerResearchProfiles = [
  {
    ...
    evidencePaths: [
      ...
      ".reference/experiments/scratchpads/provider-vidking/HDTODAY_VIDKING_DECRYPT_REPORT.md",
  ...
  },
  {
    ...
    evidencePaths: [
      ...
      ".reference/experiments/scratchpads/provider-rivestream/rivestream-headless.ts",
    ],
  ...
  },
  {
    ...
    evidencePaths: [
      ...
      ".reference/experiments/scratchpads/provider-miruro/miruro-0-ram-scraper.ts",
    ],
  ...
  },
  {
    ...
    evidencePaths: [
      ".reference/experiments/scratchpads/provider-anikai/ANIKAI_WRAPPER_REPORT.md",
      ".reference/experiments/scratchpads/provider-anikai/anikai-headless.ts",
    ],
  ...
  },
  {
    ...
    evidencePaths: [
      ...
      ".reference/experiments/scratchpads/provider-cineby/cineby.ts",
    ],
