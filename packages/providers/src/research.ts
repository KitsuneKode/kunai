...
export const providerResearchProfiles = [
  ...
  },
  {
    ...
    evidencePaths: [
      "apps/cli/src/legacy/providers/cineby.ts",
  ...
  },
  {
    ...
    evidencePaths: ["apps/cli/src/legacy/providers/bitcine.ts"],
  ...
  },
  {
    ...
    evidencePaths: ["apps/cli/src/legacy/providers/cineby-anime.ts"],
    runtimeClass: "Playwright legacy wrapper",
    implementationSource: "production-code",
    supportedContent: ["anime"],
