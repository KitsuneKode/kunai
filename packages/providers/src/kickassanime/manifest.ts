...
export const kickassanimeManifest = defineProviderManifest({
  ...
  notes: [
    ...
    "The domain rotates (kaa.to -> kaa.mx -> kickass-anime.ro -> kaa.lt). kickass-anime.ro still redirects to the current one, and is what the adapter asks when kaa.lt stops answering.",
  ],
});
