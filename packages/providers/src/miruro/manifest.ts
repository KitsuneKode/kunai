...
export const miruroManifest = defineProviderManifest({
  ...
  notes: [
    ...
    "2026-09-11: the pipe returns a backend's URL whether or not that backend is up — `pewe` served hls.anidb.app URLs (503) through AniDB's maintenance, and won the cycle. Candidates are now rejected on 404/410/5xx from one ranged GET; never on 401/403/429, which owocdn returns to Bun's fetch while mpv plays.",
