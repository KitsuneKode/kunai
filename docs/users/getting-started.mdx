...
Empty anime search with AniDB configured often means **curl is missing** — AniDB sits behind Cloudflare. `kunai doctor` reports curl. See [Troubleshooting](/docs/users/troubleshooting).
