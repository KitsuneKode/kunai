...
| --- | --- | --- | --- | --- |
| Linux (supported) | `install.sh` or bun/npm global | mpv | yt-dlp + ffprobe | Kitty / half-block (`chafa` optional) |
| macOS (beta) | `install.sh` or bun/npm global | mpv | yt-dlp + ffprobe | half-block (`chafa` optional) |
| Windows x64 (beta) | `install.ps1` or bun/npm global | mpv | yt-dlp | half-block (`chafa` optional) |
| Windows ARM64 (experimental) | `install.ps1` | mpv | yt-dlp | half-block (`chafa` optional) |
