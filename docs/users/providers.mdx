...
**Adapter role:** third in the default anime order, behind Miruro and AnimeGG. Selected directly, Kunai
...
{
  "animeProvider": "anidb",
  "animeProviderPriority": ["anidb", "miruro", "animegg", "allanime"]
}
```
...
**Adapter role:** fourth in the default anime order, behind Miruro, AnimeGG and AniDB. Display name is AllManga; the runtime id is `allanime`. It carries the ani-cli parity path, which is why it stays registered even when its stream API is gated.
