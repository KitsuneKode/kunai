...
Install paths are documented once on [Getting started](/docs/users/getting-started) and [Install and update](/docs/users/install-and-update). In beta:

- **Bun global** — primary tested JS install (`bun install -g @kitsunekode/kunai`)
- **Binary installers** — embed Bun; you still need `mpv`
- **Source checkout** — for contributors (`bun run link:global`)
