...
| AnimeGG (`animegg`) | Anime | Active, second in the anime order |
| AniDB (`anidb`) | Anime | Active, third in the anime order |
| AllManga-compatible (`allanime`) | Anime | Active, fourth in the anime order |
