...
Generated from `.reference/design/cli` on 2026-05-23. Source code remains the truth; this bundle exists so another design or implementation agent can ingest the current CLI design direction in one file.
...
- Update `.reference/design/cli` when implementation intentionally changes the contract.
