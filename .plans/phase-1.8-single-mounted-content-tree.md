...
Reconciled against [archive/plan-implementation-truth.md](../.archive/plans/plan-implementation-truth.md). Phase 1.5 root host, overlays, and pickers are landed; this phase is the remaining seam (phase loops vs one content tree).
