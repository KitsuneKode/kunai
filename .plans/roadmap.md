...
| Track                      | Remaining                                                                                                         | Plan                                                                                                                                                                                                                                           |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mobile terminal handoff    | Android core implemented; physical qualification remains; mobile Android/iOS host-proof implementation is planned | [Android design](./mobile-terminal-handoff.md) · [Android implementation](./mobile-terminal-handoff-implementation.md) · [mobile app design](./mobile-app-runtime.md) · [host-proof implementation](./mobile-app-host-proof-implementation.md) |
