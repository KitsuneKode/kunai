...
- Attention, queue, notifications, playlist sharing, and crash-recoverable queue execution now have a foundation in code: shared media actions, local inbox storage, queue recovery checkpoints/restore, playlist import/export helpers/service, deterministic refresh planning, and feature docs. Next is richer surface wiring and provider availability sync behind the experimental flag: [.plans/attention-queue-notifications-playlists.md](.plans/attention-queue-notifications-playlists.md)
