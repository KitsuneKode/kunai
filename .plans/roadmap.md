...
| Track                      | Remaining                                                                                                                  | Plan                                                                                                                                                                                                                    |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mobile terminal handoff    | Android/iOS host-proof artifacts implemented; physical qualification, catalog/providers, installers, and publishing remain | [runtime](../.docs/mobile-terminal-runtime.md) · [Android design](./mobile-terminal-handoff.md) · [mobile app design](./mobile-app-runtime.md) · [host-proof implementation](./mobile-app-host-proof-implementation.md) |
