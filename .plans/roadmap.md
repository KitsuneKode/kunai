...
| Track                      | Remaining                                                                                                          | Plan                                                                                                                                                               |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Mobile terminal runtime    | Node/a-Shell host proofs implemented; physical qualification, catalog/providers, installers, and publishing remain | [runtime](../.docs/mobile-terminal-runtime.md) · [mobile app design](./mobile-app-runtime.md) · [host-proof implementation](./mobile-app-host-proof-implementation.md) |
