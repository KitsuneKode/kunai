...
- Phase 4E resolver orchestration is underway with `@kunai/core` owning provider fallback attempt ordering while CLI providers remain app-owned.
...
| Turborepo and package boundaries | Phase 4E     | [.plans/turborepo-and-package-boundaries.md](.plans/turborepo-and-package-boundaries.md)             |
