...
- Phase 4D provider resolve-result wiring is underway with production providers attaching core `ProviderResolveResult` evidence while preserving current CLI calls.
