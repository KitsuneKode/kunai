...
| [052](../.archive/plans/052-os-credential-vault.md)   | #179  | native Keychain binding to remove `security -w` argv exposure; vault spawns off the first-paint path (measure under 060)  | PARTIAL                            |
