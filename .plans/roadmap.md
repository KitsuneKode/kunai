...
| Agent verification loop      | L2 replay + L3 tmux + real-mpv tier landed with `verify-kunai` skill. Remaining: advertised-key coverage-map spike, fresh-profile onboarding scenario, optional main-branch real-mpv CI job                        | [2026-08-31-agent-verification-harness.md](./2026-08-31-agent-verification-harness.md) |
